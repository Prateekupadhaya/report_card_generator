...
tk.Label(master,text =time_spent[4],bg="LightBlue1").grid(row=32,column=4)
...
tk.Label(master,text = attempt_status[4],bg="LightBlue1").grid(row=32,column=7)
...
tk.Label(master,text =what_you_marked[4],bg="LightBlue1").grid(row=32,column=8)
...
tk.Label(master,text =Your_Score[4],bg="LightBlue1").grid(row=32,column=11)
...
def attempted_Unattempted():
    ...
    plt.pie(data, labels = lable)
        # show plot
    plt.show().get_tk_widget().grid(row = 40,column =11)
